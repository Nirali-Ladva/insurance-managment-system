      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
				<?php
						  ...
						  $sql="select * from health_form where h_id=$id";
						  $result=mysql_query($sql,$conn);
						  $row=mysql_fetch_array($result);
				?>
						  
						  
			<form action="edithealth_proc.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
              ...
              <div class="controls">
                <input type="date" value="<?php echo $row['dob' ];?>" class="span11" name="dob" placeholder="Date Of Birth" />
              </div>
            </div>
			<div class="control-group">
			...
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text" value="<?php echo $row['healthplan'];?>" class="span11" name="healthplan" placeholder="Health Plan" />
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Relationship :</label>
              <div class="controls">
                <input type="text" value="<?php echo $row['relationship'];?>" class="span11" name="relationship" placeholder="Relationship" />
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Height :</label>
              <div class="controls">
                <input type="text" value="<?php echo $row['height'];?>" class="span11" name="height" placeholder="Height" />
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Weight :</label>
              <div class="controls">
                <input type="text" value="<?php echo $row['weight'];?>" class="span11" name="weight" placeholder="Weight" />
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Health Issue :</label>
              <div class="controls">
                <input type="text" value="<?php echo $row['health_issue'];?>" class="span11" name= "health_issue" placeholder="Health Issue " />
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Sum_assured :</label>
              <div class="controls">
                <input type="text" value="<?php echo $row['sum_assured'];?>" class="span11" name="sum_assured" placeholder="Sum_assured" />
              </div>
            </div>
			<div class="control-group">
