...
<?php
				include("conn.php");
				$id=$_SESSION['id'];
				$sql = "Select * from travel_form where status='pandding' AND agent_id=$id";
			...
			<tr>
			  ...
			  <td><?php echo $row["travelplan"]; ?></td>
			   <td><a href="../images/<?php echo $row["u_document"]; ?>"><?php echo $row["u_document"]; ?></a></td>			
			
			<td><a href="Approve_travel.php?id=<?php echo $row[0]; ?>"> Approve  </a> &nbsp; 
			
			<td><a href="edit_travel.php?id=<?php echo $row["t_id"]; ?>"> Edit </a> &nbsp; </td>
			<td><a href="delete_travel.php?id=<?php echo $row[0]; ?>"> Reject  </a> &nbsp; 
