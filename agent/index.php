    ...
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ls"> <a href="insurance.php?name=1"> <i class="icon-tint"></i> Health</a> <div class="col-xs-4">
					...
					<li class="bg_ls"> <a href="insurance.php?name=3"> <i class="icon-tint"></i> Travel</a> <div class="col-xs-4">
					<div class="box">
						<div class="panel panel-default">
					...
					<!--<li class="bg_ls"> <a href="insurance.php?name=4"> <i class="icon-tint"></i> Property</a> <div class="col-xs-4">
					<div class="box">
						<div class="panel panel-default">
							
							<div class="panel-body"><a href="insurance.php?name=4"></a></div>
          ...
          <div class="row-fluid">
            ...
            <div class="span6">
              <ul class="site-stats">
				...
				<?php
						$sql3="select * from health_form";
						$result3=mysql_query($sql3,$conn);
						$row3=mysql_num_rows($result3);
						echo $row3;
				?>
				
				</strong> <small>Health plan Users </small></li>
                <li class="bg_lh"><i class="icon-user"></i> <strong>
				<?php
						$sql3="select * from travel_form";
						$result3=mysql_query($sql3,$conn);
						$row3=mysql_num_rows($result3);
						echo $row3;
				?>
				...
				</strong> <small>Travel plan User</small></li>
                <li class="bg_lh"><i class="icon-user"></i> <strong>
				<?php
						$sql3="select * from vehicle_form";
						$result3=mysql_query($sql3,$conn);
						$row3=mysql_num_rows($result3);
						echo $row3;
				?>
				
				</strong> <small>Vehicle plan User</small></li>
                <!--<li class="bg_lh"><i class="icon-user"></i> <strong>
