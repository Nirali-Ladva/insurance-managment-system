...
<?php
				include("conn.php");
				$id = $_SESSION['id'];
				$sql = "Select * from health_form where status='pandding' AND agent_id=$id";
			...
			<tr>
			 ...
			 <!--td><a href="../images/<?php //echo $row["user_photo"]; ?>"><?php //echo $row["user_photo"]; ?></a></td-->
			...
			<td><a href="Approve_health.php?id=<?php echo $row[0]; ?>"> Approve  </a> &nbsp; 
			<td><a href="edit_health.php?id=<?php echo $row["h_id"]; ?>"> Edit </a> &nbsp; </td>
			<td><a href="delete_health.php?id=<?php echo $row[0]; ?>"> Reject </a> &nbsp; </td>
